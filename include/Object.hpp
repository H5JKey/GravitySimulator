...
private:
	...
	public:
		...
		float radius;				 //in px --- 1 px = 10^3 km
...
public:
	...
	Object(float mass, float radius, sf::Vector2f pos, sf::Vector2f speed = sf::Vector2f(0, 0), std::string name = "", sf::Color color = sf::Color(255, 255, 255), bool fixed = false);
